 ...
 * * <a href="http://www.arduino.cc/en/Main/ArduinoBoardYun">Arduino Y�n</a> and <a href="http://store.arduino.cc/usa/arduino-yun-rev-2">Y�n Rev2</a> running OpenWRT-Yun Release 1.5.3 (November 13th, 2014) or later.  There are known issues with earlier versions.  Visit [this page](http://www.arduino.cc/en/Main/Software) to get the latest version.
